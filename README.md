# Control Flow Chart Judge
This repository was made to allow educators to create control flow chart exercises for Dodona. Please note, this judge has a very specific application which may not suit your needs. Students will be given a set of assembly instructions, they will have to use this instructions in the CVG Builder to create a correct control flow chart.
...
```
For creating your solution.json file you could create the control flow chart in the CFC Builder itself or use our automated CFC Builder tool (*coming soon*).
